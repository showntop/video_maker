...
def main():
	...
	for folder in os.listdir(videos_folder_path):
		...
		caption_file = "./%s/%s_baidu_ocr_result.txt" % (one_video_folder_path, folder)
		file_name_output = "./%s/%s_category_result.txt" % (one_video_folder_path, folder)
		classify_result_file = "./%s/classify_result.txt" % (one_video_folder_path)
